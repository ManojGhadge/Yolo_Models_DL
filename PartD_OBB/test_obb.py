...
def main():
    parser = argparse.ArgumentParser(description="Test YOLO OBB detection model on new data")
    parser.add_argument("image_path", help="Path to the image file to test")
    parser.add_argument("--model_path", default="D:\\DEEP_LEARNING\\YOLO-ASSIGNMENT\\PartD_OBB\\runs\\obb\\runs\\obb\\aerial_obb\\weights\\best.pt", help="Path to the trained model")
    ...
    for result in results:
        ...
        print(f"OBB Detections: {len(result.obb)}")
